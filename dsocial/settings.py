...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'social_django.context_processors.backends', # acrescentado social_django
                'social_django.context_processors.login_redirect', #acrescentado social_django
            ],
        },
    },
]
...
AUTHENTICATION_BACKENDS = [
    ...
    'django.contrib.auth.backends.ModelBackend', # para manter também autenticação padrão
]
